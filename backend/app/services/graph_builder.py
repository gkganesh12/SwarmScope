...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "SwarmScope Graph",
        chunk_size: int = 500,
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"swarmscope_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="SwarmScope Social Simulation Graph"
        )
    ...
    def add_text_batches(
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            if progress_callback:
                ...
                progress_callback(
                    f"Sending batch {batch_num}/{total_batches} data batch ({len(batch_chunks)} chunks)...",
                    progress
                )
