...
logger = get_logger('swarmscope.zep_graph_memory_updater')
...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return "agent_name: activity description" format without simulation prefix
...
class ZepGraphMemoryUpdater:
    ...
    of BATCH_SIZE activities per platform.
    ...
    # Send interval (seconds), to avoid request flooding
    SEND_INTERVAL = 0.5
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context info (e.g., post text, usernames).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval to avoid request flooding
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        """
        Send batch of activities to Zep graph (merged into one text)
