...
2. Simulation script polls the commands directory, executes commands, writes responses to responses/
...
logger = get_logger('swarmscope.simulation_ipc')
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview on both platforms in dual-platform simulation, or the active platform in single-platform simulation
            timeout: Timeout
    ...
    def check_env_alive(self) -> bool:
        ...
        Checks via the env_status.json file
        """
