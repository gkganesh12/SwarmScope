...
Manages dual-platform (Twitter and Reddit) parallel simulation
...
logger = get_logger('swarmscope.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to generate simulation config (time, activity, posting frequency, etc.)
        ...
        try:
            ...
            # When starting simulation, simulation_runner runs scripts from scripts/
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. Activate conda environment: conda activate SwarmScope\n"
