...
logger = get_logger('swarmscope.zep_entity_reader')
...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        - If a node's labels include tags beyond "Entity" and "Node", it matches a predefined type; keep it
        ...
        for node in all_nodes:
            ...
            # Filtering logic: labels must include tags beyond "Entity" and "Node"
