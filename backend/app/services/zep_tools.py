...
1. InsightForge (Deep Insight Search) - Most powerful hybrid search, auto-generates sub-questions for multi-dimensional search
...
logger = get_logger('swarmscope.zep_tools')
...
class InsightForgeResult:
    ...
    Contains search results from multiple sub-questions and comprehensive analysis
    """
    query: str
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"- Currently valid fact: {self.active_count}items",
...
class AgentInterview:
    ...
    def to_text(self) -> str:
        ...
        # Display complete agent_bio, not truncated
...
class ZepToolsService:
    ...
    [Core search tools - optimized]
    1. insight_forge - Deep insight search (most powerful, auto-generates sub-questions, multi-dimensional)
    ...
    def get_all_nodes(self, graph_id: str) -> List[NodeInfo]:
        ...
        Returns:
            Node list
        """
        logger.info(f"Getting graph {graph_id} 's all nodes...")
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all graph edges (paginated, including temporal info)
        ...
        """
        logger.info(f"Getting graph {graph_id} 's all edges...")
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Returns:
            Edge list
        """
        logger.info(f"Get node {node_uuid[:8]}... 's related edges")
    ...
    def get_entities_by_type(
        ...
        """
        logger.info(f"Getting entities of type {entity_type}  entities...")
        ...
        logger.info(f"Found {len(filtered)} entities {entity_type} entities of type")
        return filtered
    ...
    def get_entity_summary(
        ...
        Search all info related to this entity and generate summary
        ...
        Returns:
            Entity summary info
        """
        logger.info(f"Getting entity {entity_name} 's relationship summary...")
    ...
    def get_graph_statistics(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Statistics
        """
        logger.info(f"Getting graph {graph_id} 's statistics...")
    ...
    def get_simulation_context(
        ...
        Args:
            ...
            limit: Limit on number of each type of info
    ...
    def insight_forge(
        ...
        Most powerful hybrid search function, auto-decomposes questions for multi-dimensional search:
        ...
        Args:
            ...
            query: User question
            simulation_requirement: Simulation requirement description
            report_context: Report context (Options, for more precise sub-question generation)
        ...
        for uuid in list(entity_uuids):  # Process all entities, no truncation
            if not uuid:
                continue
            try:
                # Get each related node's information separately
    ...
    def _generate_sub_queries(
        ...
        Decompose complex question into multiple independently searchable sub-questions
        """
...
4. Return JSON format: {"sub_queries": ["sub_question1", "sub_question2", ...]}"""
...
Return sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring full event overview and evolution tracking.
    ...
    def interview_agents(
        ...
        Call real OASIS interview API, interview running Agents in simulation:
        ...
        4. Call /api/simulation/interview/batch API for real interviews (dual-platform simultaneous interviews)
        5. Integrate all interview results, generate interview report
        
        [Important] This feature requires simulation environment to be running (OASIS environment not closed)
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement background (Options)
            max_agents: Max number of Agents to interview
            custom_questions: Custom interview questions (Options, auto-generated if not provided)
        ...
        if not profiles:
            logger.warning(f"Simulation not found {simulation_id} 's profile files")
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "5. Separate each question's answer with blank lines\n"
            "6. Answers should have substantive content, each question at least 2-3 sentences\n\n"
        )
        ...
        try:
            ...
            logger.info(f"Calling batch interview API (dual-platform): {len(interviews_request)} entitiesAgent")
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select from the simulation based on interview requirementsAgentlist to select the best interview subjects.

Selection criteria:
1. Agent's identity/profession is related to interview topic
...
Please select at most{max_agents}most suitable Agents for interview, and explain the selection reasoning."""
    ...
    def _generate_interview_questions(
        ...
        system_prompt = """You are a professional journalist/interviewer. Generate 3-5 in-depth interview questions based on requirements.
...
Please generate 3-5 interview questions."""
    ...
    def _generate_interview_summary(
        ...
        system_prompt = """You are a professional news editor. Please generate an interview summary report based on multiple respondents' answers.
...
- When quoting respondents, use quotation marks
