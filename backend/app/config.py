...
Loads config uniformly from the project root .env file
"""
...
# Path: SwarmScope/.env (relative to backend/app/config.py)
...
class Config:
    ...
    # Flask config
    SECRET_KEY = os.environ.get('SECRET_KEY', 'swarmscope-secret-key')
    DEBUG = os.environ.get('FLASK_DEBUG', 'True').lower() == 'true'
    
    # JSON config - disable ASCII escaping to display Unicode directly
    JSON_AS_ASCII = False
