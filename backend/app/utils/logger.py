...
Provides unified logging management with console and file output
"""
...
def _ensure_utf8_stdout():
    ...
    Fixes garbled Chinese characters in Windows console
    """
...
def setup_logger(name: str = 'swarmscope', level: int = logging.DEBUG) -> logging.Logger:
    """
    Set up a logger
...
def get_logger(name: str = 'swarmscope') -> logging.Logger:
    """
