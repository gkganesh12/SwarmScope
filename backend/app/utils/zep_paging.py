...
transparently returning full lists to callers.
"""
...
logger = get_logger('swarmscope.zep_paging')
...
def fetch_all_nodes(
    ...
    """Fetch all graph nodes with pagination, returning up to max_items (default 2000). Each page request has built-in retry."""
    all_nodes: list[Any] = []
